...
required large amounts of easy but repetitive numerical operations, a task that
was both slow and error prone :fperez:`find Feynman's original description of
Los Alamos computation rooms`.  For a long time, computing equipment was a a
scarce and expensive resource, and simple economics dictated that priority was
given to maximizing the efficiency in using this expensive hardware.  Whether
...
available, the more FORTRAN began to feel too "low-level", and even
...
teaching them rather than the pesky details of 



It became rapidly obvious 
...
Contrast the simplicity of that program with the complexity of an
equivalent "hello world" in Java:
